...
/**
 * Root page — the conversation thread with app shell.
 * Header + thread + bottom nav. The entire product on one screen.
 */
      ...
      >
        <Link
          ...
          className={[
            ...
            'transition-colors duration-instant no-underline',
